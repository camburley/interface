        ...
        <div className="w-full max-w-4xl">
          <div className="mb-6">
            <span className="inline-block border border-accent/40 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.3em] text-accent">
              One person · AI-powered · Pause anytime
            </span>
          </div>
          ...
          <p className="mt-8 max-w-xl font-mono text-base text-muted-foreground leading-relaxed">
            Production-grade builds delivered in days, not months. One flat monthly rate. No contracts. Pause or cancel anytime.
          </p>
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            >
              <ScrambleTextOnHover text="See Plans" as="span" duration={0.6} />
          ...
          <p className="mt-8 font-mono text-[10px] text-muted-foreground/50 uppercase tracking-widest">
            Currently accepting 3 new subscribers
          </p>
        </div>
      </div>
    </section>
