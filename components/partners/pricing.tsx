...
const plans = [
  ...
  },
  {
    ...
    priceId: "scale",
    period: "/month",
    description: "Fully managed delivery with higher throughput, strategy sessions, and faster turnaround.",
    features: [
      "Unlimited queue",
      "Three active tasks at a time",
      "Tasks within 24 business hrs",
      "Fully managed delivery",
      "Biweekly strategy sessions",
      "Loom/video walkthroughs",
      "Priority queuing across all tasks",
      "Pause or cancel anytime",
    ],
    highlighted: false,
  },
