...
export function ColophonSection() {
  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Burley Lab</li>
          </ul>
        </div>
      ...
      {/* Bottom copyright */}
      <div ref={footerRef} className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <p className="font-mono text-xs text-muted-foreground">Burley AI LLC • cam@burley.ai • © 2026</p>
        <p className="font-mono text-xs text-muted-foreground">Built with intention. Shipped with speed.</p>
      </div>
    </section>
  )
}
